...
import { createArtist, getArtistImageUploadUrl, getUploadUrl, setImages3Key } from "./admin.controller.js";
...
// add validation =====>
// create a middleware for check artist created or not ==----==>
// add rate limiting ==----==>

router.post("/getuploadurl",protectAdminRoute,getUploadUrl);
